...
export default function DashboardView({ coordinates, onSelectDepartment, backendUrl }) {
  ...
  const [stats, setStats] = useState({ records: "20,196", r2: "71.86%" });
  ...
  return (
    <div className="max-w-[1440px] mx-auto space-y-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-lg">
        {/* Registros */}
        <div className="bg-white border border-outline-variant p-lg rounded-xl flex items-center gap-lg shadow-[0px_4px_20px_rgba(30,58,95,0.04)]">
        ...
        {/* Rango */}
        <div className="bg-white border border-outline-variant border-l-4 border-l-secondary p-lg rounded-xl flex items-center gap-lg shadow-[0px_4px_20px_rgba(30,58,95,0.04)]">
      ...
      <div className="grid grid-cols-12 gap-lg">
        ...
        <div className="col-span-12 lg:col-span-8 flex flex-col gap-md">
          <div className="bg-white border border-outline-variant rounded-xl overflow-hidden flex flex-col relative shadow-[0px_4px_20px_rgba(30,58,95,0.04)]" style={{ height: "600px" }}>
            <div className="p-md bg-white/80 backdrop-blur-sm z-10 border-b border-outline-variant flex justify-between items-center">
              ...
              <div className="flex items-center gap-sm">
                <span className="text-[12px] font-medium text-on-surface-variant">
                  Monitoreo de Vigilancia Activa
                </span>
            ...
            <div className="flex-1 relative">
              ...
              {/* Map Legend */}
              <div
                className="absolute bottom-md left-md bg-white/95 backdrop-blur-md p-md rounded-lg border border-outline-variant/30 max-w-[240px] shadow-[0px_4px_20px_rgba(30,58,95,0.04)]"
                style={{ zIndex: 1000 }}
              >
        ...
        <div className="col-span-12 lg:col-span-4 flex flex-col gap-lg">
          {/* Incidence Summary */}
          <div className="bg-white border border-outline-variant p-lg rounded-xl flex-1 flex flex-col justify-between shadow-[0px_4px_20px_rgba(30,58,95,0.04)]">
            ...
            <button
              onClick={() => alert("Reporte PDF generado y guardado en almacenamiento local.")}
          ...
          <div className="bg-primary text-on-primary p-lg rounded-xl shadow-xl">
            ...
            <p className="text-body-md opacity-90 leading-relaxed">
              El motor integra la red <strong>MLP PyTorch</strong> (MAE de test de <strong>12.56</strong>) y <strong>XGBoost</strong> (MAE de test de <strong>10.46</strong>). El Ensemble combinado reduce el error absoluto medio (MAE) a <strong>11.36</strong>, capturando picos y mitigando falsos positivos.
            </p>
